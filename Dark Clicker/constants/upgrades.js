...
function createUpgrades() {
  ...
  defaultUpgradeValues.forEach((obj) => {
    ...
    let html = template; // Will contain all the information for each upgrade with dynamic values
...
export const upgrades = [
  ...
  },
  {
    ...
    parsedIncrease: parseFloat(
      document.querySelector(".rocket-increase").innerHTML
    ),
  ...
  },
  {
    ...
    parsedIncrease: parseFloat(
      document.querySelector(".satellite-increase").innerHTML
    ),
  ...
  },
  {
    ...
    parsedIncrease: parseFloat(
      document.querySelector(".planet-increase").innerHTML
    ),
  ...
  },
  {
    ...
    parsedIncrease: parseFloat(
      document.querySelector(".astronaut-increase").innerHTML
    ),
...
upgrades.forEach((upgrade) => {
  ...
  upgrade.parsedIncrease = parseFloat(upgrade.increase.innerHTML);
});
